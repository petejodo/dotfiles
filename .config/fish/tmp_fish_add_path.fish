# TODO
# This is pulled directly from the github pull request:
#   https://github.com/fish-shell/fish-shell/pull/7028/files
# Since this will only be added in fish v3.2.0 and the current release
# is 3.1.2. Remove this function once upgrading to v3.2.0 since it
